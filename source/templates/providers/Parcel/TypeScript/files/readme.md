# Phaser 3 + Phaser Editor 2D + TypeScript + Parcel Template

> For people who want to spend time making Phaser 3 games in TypeScript instead of configuring build tools.

## Author

This template is a fork of the [Ourcade's TypeScript + Parcel Template for Phaser 3](https://github.com/ourcade/phaser3-typescript-parcel-template). We, the Phaser Editor 2D team, added a couple of files and configurations focused on the Phaser Editor 2D tools.
