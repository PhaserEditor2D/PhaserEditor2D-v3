...
namespace colibri.ui.controls.viewers {
    ...
    export type ISectionCriteria = (obj: any) => boolean;

    export class GridTreeViewerRenderer2 extends TreeViewerRenderer {

        private _center: boolean;
        private _flat: boolean;
        private _sectionCriteria: ISectionCriteria;
        ...
        setSectionCriteria(sectionCriteria: ISectionCriteria) {

            this._sectionCriteria = sectionCriteria;
        }

        getSectionCriteria() {

            return this._sectionCriteria;
        }

        private isSection(obj: any) {

            if (this._sectionCriteria) {

                return this._sectionCriteria(obj);
            }
