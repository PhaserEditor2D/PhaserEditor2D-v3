                ...
                class NewAssetPackFileWizardExtension extends phasereditor2d.files.ui.dialogs.NewFileContentExtension {
                    constructor() {
                        super({
                            ...
                            dialogIcon: pack.AssetPackPlugin.getInstance().getIcon(pack.ICON_ASSET_PACK),
            ...
            (function (editor) {
                ...
                class AssetPackEditor extends ide.ViewerFileEditor {
                    constructor() {
                        ...
                        this._propertyProvider = new editor.properties.AssetPackEditorPropertyProvider();
                    ...
                    createEditorToolbar(parent) {
                        ...
                        manager.addCommand(pack.CMD_ASSET_PACK_EDITOR_ADD_FILE);
                        return manager;
                    }
                    openAddFileDialog() {
                        const viewer = new controls.viewers.TreeViewer();
        ...
        (function (ui) {
            ...
            (function (editor_7) {
                class IgnoreFileSet extends Set {
                    ...
                    async updateIgnoreFileSet_async() {
                        const packs = (await pack_33.core.AssetPackUtils.getAllPacks())
    ...
    (function (pack) {
        ...
        (function (ui) {
            ...
            (function (editor_9) {
                ...
                })(undo = editor_9.undo || (editor_9.undo = {}));
            })(editor = ui.editor || (ui.editor = {}));
        })(ui = pack.ui || (pack.ui = {}));
    })(pack = phasereditor2d.pack || (phasereditor2d.pack = {}));
})(phasereditor2d || (phasereditor2d = {}));
