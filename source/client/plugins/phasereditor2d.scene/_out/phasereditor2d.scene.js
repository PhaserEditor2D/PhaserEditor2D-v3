    ...
    (function (scene_1) {
        ...
        class ScenePlugin extends colibri.Plugin {
            ...
            registerExtensions(reg) {
                ...
                // property sections
                reg.addExtension(new scene_1.ui.editor.properties.SceneEditorPropertySectionExtension(page => new scene_1.ui.sceneobjects.VariableSection(page), page => new scene_1.ui.sceneobjects.TransformSection(page), page => new scene_1.ui.sceneobjects.OriginSection(page), page => new scene_1.ui.sceneobjects.TileSpriteSection(page), page => new scene_1.ui.sceneobjects.TextureSection(page)));
                // scene tools
            ...
            (function (editor_2) {
                ...
                class AddObjectDialog extends controls.dialogs.ViewerDialog {
                    ...
                    create() {
                        ...
                        viewer.setLabelProvider(new controls.viewers.LabelProvider((ext) => {
                            return ext.getTypeName();
                        }));
                        viewer.setContentProvider(new controls.viewers.ArrayTreeContentProvider());
                        viewer.setCellRendererProvider(new controls.viewers.EmptyCellRendererProvider(_ => new controls.viewers.IconImageCellRenderer(scene.ScenePlugin.getInstance().getIcon(scene.ICON_GROUP))));
                        viewer.setInput(scene.ScenePlugin.getInstance().getObjectExtensions());
                        super.create();
                        this.style.width = "20em";
                        this.setTitle("Add Object");
                        const createObject = () => {
                            const ext = viewer.getSelectionFirstElement();
                        ...
                        btn.disabled = true;
                        viewer.addEventListener(controls.EVENT_SELECTION_CHANGED, e => btn.disabled = (viewer.getSelection().length !== 1));
                ...
                class DropManager {
                    ...
                    async onDragDrop_async(e) {
                        ...
                        if (this.acceptDropDataArray(dataArray)) {
                            ...
                            this._editor.getUndoManager().add(new editor_4.undo.AddObjectsOperation(this._editor, sprites));
    ...
    (function (scene) {
        ...
        (function (ui) {
            ...
            (function (editor_5) {
                ...
                editor_5.MouseManager = MouseManager;
            })(editor = ui.editor || (ui.editor = {}));
        })(ui = scene.ui || (scene.ui = {}));
    })(scene = phasereditor2d.scene || (phasereditor2d.scene = {}));
})(phasereditor2d || (phasereditor2d = {}));
    ...
    (function (scene) {
        ...
        (function (ui) {
            ...
            (function (editor_6) {
                ...
                editor_6.OverlayLayer = OverlayLayer;
            })(editor = ui.editor || (ui.editor = {}));
        })(ui = scene.ui || (scene.ui = {}));
    })(scene = phasereditor2d.scene || (phasereditor2d.scene = {}));
})(phasereditor2d || (phasereditor2d = {}));
    ...
    (function (scene_10) {
        ...
        (function (ui) {
            ...
            (function (editor_7) {
                ...
                editor_7.SelectionManager = SelectionManager;
            })(editor = ui.editor || (ui.editor = {}));
    ...
    (function (scene) {
        ...
        (function (ui) {
            ...
            (function (editor_8) {
                ...
                (function (commands) {
                    ...
                    class SceneEditorCommands {
                        static registerCommands(manager) {
                            ...
                            manager.addHandlerHelper(colibri.ui.ide.actions.CMD_UPDATE_CURRENT_EDITOR, args => args.activeEditor instanceof editor_8.SceneEditor, args => args.activeEditor.refreshScene());
                            // select all
                            manager.addHandlerHelper(colibri.ui.ide.actions.CMD_SELECT_ALL, args => args.activePart instanceof editor_8.SceneEditor, args => {
                            ...
                            manager.addHandlerHelper(commands.CMD_OPEN_COMPILED_FILE, args => args.activeEditor instanceof editor_8.SceneEditor, args => args.activeEditor.openSourceFileInEditor());
                            ...
                            manager.addHandlerHelper(commands.CMD_COMPILE_SCENE_EDITOR, args => args.activeEditor instanceof editor_8.SceneEditor, args => args.activeEditor.compile());
                ...
                })(commands = editor_8.commands || (editor_8.commands = {}));
            })(editor = ui.editor || (ui.editor = {}));
        })(ui = scene.ui || (scene.ui = {}));
    })(scene = phasereditor2d.scene || (phasereditor2d.scene = {}));
})(phasereditor2d || (phasereditor2d = {}));
    ...
    (function (scene) {
        ...
        (function (ui) {
            ...
            (function (editor_10) {
                ...
                })(outline = editor_10.outline || (editor_10.outline = {}));
            })(editor = ui.editor || (ui.editor = {}));
        })(ui = scene.ui || (scene.ui = {}));
    })(scene = phasereditor2d.scene || (phasereditor2d.scene = {}));
})(phasereditor2d || (phasereditor2d = {}));
    ...
    (function (scene) {
        ...
        (function (ui) {
            ...
            (function (editor_14) {
                ...
                })(tools = editor_14.tools || (editor_14.tools = {}));
            })(editor = ui.editor || (ui.editor = {}));
        })(ui = scene.ui || (scene.ui = {}));
    })(scene = phasereditor2d.scene || (phasereditor2d.scene = {}));
})(phasereditor2d || (phasereditor2d = {}));
        ...
        (function (ui) {
            ...
            (function (sceneobjects) {
                class Sprite extends Phaser.GameObjects.Image {
                    constructor(scene, x, y, texture, frame) {
                        super(scene, x, y, texture, frame);
                        this._editorSupport = new sceneobjects.SpriteEditorSupport(this);
                    }
                    getEditorSupport() {
                        return this._editorSupport;
                    }
        ...
        (function (ui) {
            ...
            (function (sceneobjects) {
                class SpriteEditorSupport extends sceneobjects.BaseImageEditorSupport {
                    constructor(obj) {
                        super(sceneobjects.SpriteExtension.getInstance(), obj);
                    }
                }
            ...
            (function (sceneobjects) {
                class TileSprite extends Phaser.GameObjects.TileSprite {
                    constructor(scene, x, y, width, height, texture, frame) {
                        ...
                        this._editorSupport = new sceneobjects.TileSpriteEditorSupport(this);
                    }
                    getEditorSupport() {
                        return this._editorSupport;
                    }
                ...
                class TileSpriteCodeDOMBuilder extends sceneobjects.BaseImageCodeDOMBuilder {
                    ...
                    addArgsToObjectFactoryMethodCallDOM(call, obj) {
                        ...
                        if (support.isPrefabInstance()) {
                            const prefabSerializer = support.getPrefabSerializer();
                            if (prefabSerializer) {
                                if (!prefabSerializer.isUnlocked(sceneobjects.TileSpriteComponent.width.name)) {
                                    width = undefined;
                                }
                                if (!prefabSerializer.isUnlocked(sceneobjects.TileSpriteComponent.height.name)) {
                                    height = undefined;
                                }
                            }
                            else {
